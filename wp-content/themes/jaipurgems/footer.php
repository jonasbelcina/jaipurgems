...
?>
	...
	<footer>
		...
		<div class="help-popup">
			<a href="" data-toggle="modal" data-target="#support-popup">Need Help?</a>
		</div>
	...
	<!-- Need Help Modal -->
	<div class="modal fade" id="support-popup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				...
				<div class="modal-body">
					<p>Share your details and our customer service team will contact you.</p>
					<?php echo do_shortcode('[contact-form-7 id="638" title="Need Help"]'); ?>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="modal fade" id="campaignPopup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
							<a href="http://ramadan.jaipurgems.ae/?utm_source=pop-up-home-page&utm_medium=banner&utm_campaign=ramadan" target="_blank"><img class="img-responsive desktop-rp" src="<?php echo get_template_directory_uri(); ?>/assets/images/ramadan-popup.png" alt="Ramadan Rewards" /><img class="img-responsive mobile-rp" src="<?php echo get_template_directory_uri(); ?>/assets/images/ramadan-popup-mob.png" alt="Ramadan Rewards" /></a>
					</div>
				</div>
			</div>
		</div>
...
<?php if(is_page('453')) : ?>
	...
	<script type="text/javascript">
		...
		$('.show-around .more-button.hide-map').on('click', function() {
